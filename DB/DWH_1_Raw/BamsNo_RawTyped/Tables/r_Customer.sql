CREATE TABLE [BamsNo_RawTyped].[r_Customer] (
    ...
    CONSTRAINT [PK_BamsNo_RawTyped_r_Customer] PRIMARY KEY CLUSTERED ([Customer_bkey] ASC, [SysValidFromDateTime] DESC) WITH (DATA_COMPRESSION = PAGE)
);
...
GO
CREATE NONCLUSTERED INDEX [NCIDX_SysModifiedUTC_BamsNo_RawTyped_r_Customer]
    ON [BamsNo_RawTyped].[r_Customer]([SysModifiedUTC] ASC) WITH (DATA_COMPRESSION = PAGE);
