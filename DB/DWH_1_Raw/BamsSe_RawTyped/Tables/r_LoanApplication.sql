CREATE TABLE [BamsSe_RawTyped].[r_LoanApplication] (
    ...
    CONSTRAINT [PK_BamsSe_RawTyped_r_LoanApplication] PRIMARY KEY CLUSTERED ([LoanApplication_bkey] ASC, [SysValidFromDateTime] DESC) WITH (DATA_COMPRESSION = PAGE)
);
...
GO
CREATE NONCLUSTERED INDEX [NCIDX_SysModifiedUTC_BamsSe_RawTyped_r_LoanApplication]
    ON [BamsSe_RawTyped].[r_LoanApplication]([SysModifiedUTC] ASC) WITH (DATA_COMPRESSION = PAGE);
