CREATE TABLE [BamsSe_RawTyped].[r_OpocLoanApplication] (
    ...
    CONSTRAINT [PK_BamsSe_RawTyped_r_OpocLoanApplication] PRIMARY KEY CLUSTERED ([OpocLoanApplication_bkey] ASC, [SysValidFromDateTime] DESC) WITH (DATA_COMPRESSION = PAGE)
);
...
GO
CREATE NONCLUSTERED INDEX [NCIDX_SysModifiedUTC_BamsSe_RawTyped_r_OpocLoanApplication]
    ON [BamsSe_RawTyped].[r_OpocLoanApplication]([SysModifiedUTC] ASC) WITH (DATA_COMPRESSION = PAGE);


GO
CREATE NONCLUSTERED INDEX [NCIDX_SysSrcGenerationDateTime_BamsSe_RawTyped_r_OpocLoanApplication]
    ON [BamsSe_RawTyped].[r_OpocLoanApplication]([SysSrcGenerationDateTime] ASC) WITH (DATA_COMPRESSION = PAGE);
