CREATE TABLE [BamsSe_RawTyped].[r_OpocCustomer] (
    ...
    CONSTRAINT [PK_BamsSe_RawTyped_r_OpocCustomer] PRIMARY KEY CLUSTERED ([OpocCustomer_bkey] ASC, [SysValidFromDateTime] DESC) WITH (DATA_COMPRESSION = PAGE)
);
...
GO
CREATE NONCLUSTERED INDEX [NCIDX_SysModifiedUTC_BamsSe_RawTyped_r_OpocCustomer]
    ON [BamsSe_RawTyped].[r_OpocCustomer]([SysModifiedUTC] ASC) WITH (DATA_COMPRESSION = PAGE);
