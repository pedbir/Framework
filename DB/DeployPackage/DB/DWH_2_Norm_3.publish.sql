...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [Norm_Index_38E55E9F], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_Norm_Index_38E55E9F.mdf') TO FILEGROUP [Norm_Index];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [Norm_Data_68BB2F35], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_Norm_Data_68BB2F35.mdf') TO FILEGROUP [Norm_Data];
