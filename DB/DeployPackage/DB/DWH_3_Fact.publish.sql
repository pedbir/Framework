...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [Fact_Index_6D5E7B13], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_Fact_Index_6D5E7B13.mdf') TO FILEGROUP [Fact_Index];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [Fact_Data_258A9DF8], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_Fact_Data_258A9DF8.mdf') TO FILEGROUP [Fact_Data];
