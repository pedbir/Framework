...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [Fact_Index_2970EF4F], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_Fact_Index_2970EF4F.mdf') TO FILEGROUP [Fact_Index];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [Fact_Data_5C93183], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_Fact_Data_5C93183.mdf') TO FILEGROUP [Fact_Data];
