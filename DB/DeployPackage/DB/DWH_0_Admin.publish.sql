...
GO
ALTER TABLE [Logging].[PackageVersion]
...
INSERT INTO dbo.SSISConfigurations(ConfigurationFilter, ConfiguredValue, PackagePath, ConfiguredValueType)
SELECT 			'DWH_3_Fact',	'Data Source=eqtdwbuildsrv01;Initial Catalog=DWH_3_Fact;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;',	'\Package.Connections[DWH_3_Fact].Properties[ConnectionString]',	'String'
UNION SELECT 	'DWH_2_Norm',	'Data Source=eqtdwbuildsrv01;Initial Catalog=DWH_2_Norm;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;',	'\Package.Connections[DWH_2_Norm].Properties[ConnectionString]',	'String'
UNION SELECT 	'DWH_1_Raw',	'Data Source=eqtdwbuildsrv01;Initial Catalog=DWH_1_Raw;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;',	'\Package.Connections[DWH_1_Raw].Properties[ConnectionString]',	'String'
UNION SELECT	'SSAS_Server',	'Data Source=eqtdwbuildsrv01;PROVIDER=MSOLAP;Impersonation Level=Impersonate;',	'\Package.Connections[SSAS_Server].Properties[ConnectionString]',	'String'
UNION SELECT 	'DWH_0_MDM',	'Data Source=eqtdwbuildsrv01;Initial Catalog=DWH_0_MDM;Provider=SQLNCLI11.1;Integrated Security=SSPI;Auto Translate=False;',	'\Package.Connections[DWH_0_MDM].Properties[ConnectionString]',	'String'
UNION SELECT 	'Talentsoft_SourceFolderPath',	'$(DropboxPath)\Input\Talentsoft\Data',	'\Package.Variables[User::Talentsoft_SourceFolderPath].Properties[Value]',	'String'
UNION SELECT 	'Talentsoft_ArchiveFolderPath',	'$(DropboxPath)\Input\Talentsoft\Archive',	'\Package.Variables[User::Talentsoft_ArchiveFolderPath].Properties[Value]',	'String'
UNION SELECT 	'Talentsoft_ErrorFolderPath',	'$(DropboxPath)\Input\Talentsoft\Error',	'\Package.Variables[User::Talentsoft_ErrorFolderPath].Properties[Value]',	'String'
UNION SELECT 	'Manual_SourceFolderPath',	'$(DropboxPath)\Input\Manual\Data',	'\Package.Variables[User::Manual_SourceFolderPath].Properties[Value]',	'String'
