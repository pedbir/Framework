...
SELECT	t.SysDatetimeDeletedUTC
		...
		, t.Employee_bkey
		, EmployeeName = ISNULL(NULLIF(t.EmployeeName, ''), 'Unknown')
		, Title = ISNULL(NULLIF(t.Title, ''), 'Unknown')
		, Department = ISNULL(NULLIF(t.Department, ''), 'Unknown')
		, EmployeeStatus = ISNULL(NULLIF(t.EmployeeStatus, ''), 'Unknown')
