...
CREATE  PROCEDURE [Finance].[Test that Local Currency Amount in General Ledger per Project stay persistent after new changes]
AS
BEGIN
...
------Execution
		...
		INNER JOIN  DWH_3_Fact.Finance.d_Project a ON gl.Project_key = a.Project_key 
