...
CREATE  PROCEDURE [Finance].[Test that Local Currency Amount in General Ledger per Vendor stay persistent after new changes]
AS
BEGIN
...
------Execution
		...
		INNER JOIN  DWH_3_Fact.Finance.d_Vendor a ON gl.FinanceVendor_key = a.FinanceVendor_key 
