...
CREATE  PROCEDURE [Finance].[Test that Local Currency Amount in General Ledger per Product stay persistent after new changes]
AS
BEGIN
...
------Execution
		...
		INNER JOIN  DWH_3_Fact.Finance.d_Product a ON gl.FinanceProduct_key = a.FinanceProduct_key 
